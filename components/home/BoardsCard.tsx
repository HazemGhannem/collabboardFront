...
export default function BoardsCard({ board, role }: BoardCardProps) {
  const roleHandler = () => {
  ...
  return (
    <div
      className="group flex flex-col gap-3 rounded-xl bg-zinc-900 p-4 transition-colors hover:bg-zinc-800 cursor-pointer"
